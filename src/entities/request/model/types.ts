...
export const REQUEST_STATUS_TITLE = {
    ...
    [RequestStatuses.Completed]: 'Completed',
};
...
export type RequestActiveStatus = Omit<RequestStatuses, RequestStatuses.Pending>;
...
export const REQUEST_STATUS_COLOR = {
    [RequestStatuses.Pending]: <BaseType>'warning',
    [RequestStatuses.Active]: <BaseType>'success',
    [RequestStatuses.Completed]: <BaseType>'danger',
};
